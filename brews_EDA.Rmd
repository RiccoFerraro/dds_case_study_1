...
#3 a. Plot missing data for reference
```{r}
...
#3.b. Assess missing data when no data exists for IBU OR ABV
...
#3 c. Assess and impute missing data when by hand when data is availbe publicaly. 
...
#3 d. Assess and impute missing IBU data with median IBU by style 
```{r}
# Impute IBU
...
#3 e. Plot missing data to show it has all been resolved. 
```{r}
# Plot missing data (there should be none)
