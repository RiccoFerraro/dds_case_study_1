...
knn.fit.IBU <- train(Ounces ~ State,
             method     = "knn",
             preProcess = c("center", "scale"),
             tuneGrid   = expand.grid(k = 1:10),
             trControl  = trControl,
...
print("use KNN!")
as.double(levels(bdat.IPA.Vs.Ales.train.Extra$Ounces))
...
bdat.IPA.Vs.Ales.train.Extra.filtered %>% ggplot(aes(x=Ounces, fill=State)) + geom_bar() + facet_wrap(~State) + ggtitle("Count of 12 and 16 Ounces by State")
